...
public class TestProvider extends AndroidTestCase {
    ...
    public void testProviderRegistry() {
        ...
        try {
            ...
            assertTrue("Error: WeatherProvider not registered at " + getContext().getPackageName(),
                    false);
        }
    }
    ...
    public void testUpdateLocation() {
        ...
        Cursor locationCursor = getContext().getContentResolver().query(LocationEntry.CONTENT_URI, null, null, null, null);
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate+= millisecondsInADay ) {
            ...
            weatherValues.put(WeatherContract.WeatherEntry.COLUMN_WINDSPEED, 5.5 + 0.2 * (float) i);
