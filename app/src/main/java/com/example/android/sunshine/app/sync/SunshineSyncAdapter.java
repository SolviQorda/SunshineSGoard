...
public class SunshineSyncAdapter extends AbstractThreadedSyncAdapter {
    ...
    public static final int WEATHER_NOTIFCATION_ID = 3004;
    ...
    private void getWeatherDataFromJson(String forecastJsonStr, String locationSetting)throws JSONException{
        ...
        try {
            ...
            for(int i = 0; i < weatherArray.length(); i++) {
                ...
                weatherValues.put(WeatherContract.WeatherEntry.COLUMN_WINDSPEED, windSpeed);
    ...
    private void notifyWeather() {
        ...
        if(displayNotifications){
            ...
            if(cursor.moveToFirst()) {
                ...
                //TODO: build notification Create the Notification using NotificationCompat.builder.
                ...
                Intent notiIntent = new Intent(getContext(), MainActivity.class);
                ...
                //  Tell the NotificationManager to show the notification.
                ...
                mNotificationManager.notify(WEATHER_NOTIFCATION_ID, mBuilder.build());
    ...
    // Helper method to schedule sync adapters periodic execution
    ...
    private static void onAccountCreated(Account newAccount, Context context){
        ...
        //we need to call this otherwise the sync won't be enabled
    ...
    static private void setLocationStatus(Context c, @LocationStatus int locationStatus) {
        ...
        prefsEditor.putInt(c.getString(R.string.pref_loc_status_key), locationStatus);
        prefsEditor.commit();
    }
}